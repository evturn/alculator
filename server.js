...
allStages = [
	...
	{name: "stage-three", description: "Slight impairment of balance, speech, vision, reaction time, and hearing. Judgment and self-control are reduced, and caution, reason and memory are impaired, .08 is legally impaired and it is illegal to drive at this level. You probably believe that you are functioning better than you really are", color: "two", stage: 3},
	{name: "stage-four", description: "Significant impairment of motor coordination and loss of good judgment. Speech may be slurred; balance, vision, reaction time and hearing will be impaired", color: "two", stage: 4},
	{name: "stage-five", description: "Significant impairment of motor coordination and loss of good judgment. Speech may be slurred; balance, vision, reaction time and hearing will be impaired", color: "three", stage: 5},
	{name: "stage-six", description: "Gross motor impairment and lack of physical control. Blurred vision and major loss of balance. Euphoria is reduced and dysphoria (anxiety, restlessness) is beginning to appear. Judgment and perception are severely impaired", color: "three", stage: 6},
	{name: "stage-seven", description: "Dysphoria predominates, nausea may appear. The drinker has the appearance of a 'sloppy drunk'", color: "four", stage: 7},
	{name: "stage-eight", description: "Feeling dazed, confused or otherwise disoriented. May need help to stand or walk. If you injure yourself you may not feel the pain. Some people experience nausea and vomiting at this level. The gag reflex is impaired and you can choke if you do vomit. Blackouts are likely at this level so you may not remember what has happened", color: "four", stage: 8},
	{name: "stage-nine", description: "You have little comprehension of where you are. You may pass out suddenly and be difficult to awaken. Coma is possible. This is the level of surgical anesthesia", color: "five", stage: 9},
	{name: "stage-ten", description: "Onset of coma, probable death due to respitory arrest", color: "five", stage: 10}]
